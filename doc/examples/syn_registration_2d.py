...
import cupy as cp
import cudipy.align.imwarp as imwarp
from cudipy.align.imwarp import SymmetricDiffeomorphicRegistration
from cudipy.align.metrics import CCMetric  # , SSDMetric
...
if False:
    # TODO: implement SSDMetric to enable this case
    dim = static.ndim
    ...
    mapping = sdr.optimize(cp.asarray(static), cp.asarray(moving))
...
warped = mapping.transform(moving, "linear")
